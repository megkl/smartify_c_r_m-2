...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  ...
  {
    '3p97u62u': {
      'en': 'Hello, Welcome to Smartify CRM',
      'id': 'Selamat Datang kembali!',
      'ms': 'Selamat kembali!',
    },
    'xkz4xjo6': {
      'en': 'We help manage your teams and projects effectively at your own convenience. Everything is bundled up in one place to manage notes, teams, projects, invoices and also the customer conversion process. ',
