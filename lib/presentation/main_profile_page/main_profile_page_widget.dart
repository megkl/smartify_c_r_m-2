                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Divider(
                                           ...
                                           Padding(
                                            padding: const EdgeInsets.only(
                                                bottom: 15, left: 15, top: 8),
                                            child: Row(
                                              children: [
                                                Text(
                                                 'Create groups to organise your contacts into',
                                                  style:
                                                      FlutterFlowTheme.of(context)
                                                          .bodyText2,
                                                ),
                                          ...
                                          Divider(
                                           ...
                                           Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                Text(
                                                 'Create your team and manage their tasks',
                                                  style:
                                                      FlutterFlowTheme.of(context)
                                                          .bodyText2,
                                                ),
                                          ...
                                          Divider(
                                           ...
                                           Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                Text(
                                                 'Add and manage projects for your customers',
                                                  style:
                                                      FlutterFlowTheme.of(context)
                                                          .bodyText2,
                                                ),
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        final user = await signOutWithGoogle();
                                        currentUser = null;
                                        // if (user == null) {
                                        //   return;
                                        // }
