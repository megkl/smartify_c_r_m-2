...
class EditDeleteMeetingScreen extends StatefulWidget {
   EditDeleteMeetingScreen({Key? key, this.event}) : super(key: key);
  final EventInfo? event;

  @override
  State<EditDeleteMeetingScreen> createState() => _EditDeleteMeetingScreenState();
}

class _EditDeleteMeetingScreenState extends State<EditDeleteMeetingScreen> {
