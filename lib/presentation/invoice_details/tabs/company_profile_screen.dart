...
class _EditCompanyProfileScreenState extends State<EditCompanyProfileScreen> {
 String? countrySelectedValue = 'Kenya';
  String? locationAddress = 'View Park Towers 10th floor';
  TextEditingController phoneController = TextEditingController(text: '0701254254');
  TextEditingController companyNameController = TextEditingController(text: 'Encomm Solutions');
  TextEditingController contactNameController = TextEditingController(text: 'Edward Magero');
  TextEditingController emailController = TextEditingController(text: 'edwardmagero@gmail.com');
  TextEditingController websiteController = TextEditingController(text: 'encommsolutions.co.ke');
  TextEditingController addressController = TextEditingController(text: 'View Park Towers 10th floor');
  TextEditingController locationController = TextEditingController(text: 'Nairobi');
  TextEditingController countryController = TextEditingController(text: 'Kenya');
